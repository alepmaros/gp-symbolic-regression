...
f1=$(python3 run.py -d synth1 -g 300 -k 30 -p 100 -r 20 -cp 0.9 -mp 0.05 -rp 0.05 --random-seed $SEED --timestamp $TIMESTAMP --test operator_prob | tail -1)
echo "Running operator Probability 2"
f2=$(python3 run.py -d synth1 -g 300 -k 30 -p 100 -r 20 -cp 0.7 -mp 0.25 -rp 0.05 --random-seed $SEED --timestamp $TIMESTAMP --test operator_prob | tail -1)
echo "Running operator Probability 3"
f3=$(python3 run.py -d synth1 -g 300 -k 30 -p 100 -r 20 -cp 0.5 -mp 0.45 -rp 0.05 --random-seed $SEED --timestamp $TIMESTAMP --test operator_prob | tail -1)
