...
f1=$(python3 run.py -d synth1 -g 200 -k 2 -p 100 -r 30 -cp 0.7 -mp 0.29 -rp 0.01 --random-seed $SEED --timestamp $TIMESTAMP --test best_avg | tail -1)
...
# f1=$(python3 run.py -d synth2 -g 600 -k 7 -p 100 -r 30 -cp 0.7 -mp 0.25 -rp 0.05 --random-seed $SEED --timestamp $TIMESTAMP --test allow_sin | tail -1)
# echo "Running with allow sin"
# f2=$(python3 run.py -d synth2 -g 600 -k 7 -p 100 -r 30 -cp 0.7 -mp 0.25 -rp 0.05 --allow-sin --random-seed $SEED --timestamp $TIMESTAMP --test allow_sin | tail -1)
...
# echo "Concrete"
# echo "Running with not allow sin"
# f1=$(python3 run.py -d concrete -g 600 -k 7 -p 100 -r 30 -cp 0.7 -mp 0.25 -rp 0.05 --random-seed $SEED --timestamp $TIMESTAMP --test allow_sin | tail -1)
# echo "Running with allow sin"
# f2=$(python3 run.py -d concrete -g 600 -k 7 -p 100 -r 30 -cp 0.7 -mp 0.25 -rp 0.05 --allow-sin --random-seed $SEED --timestamp $TIMESTAMP --test allow_sin | tail -1)
