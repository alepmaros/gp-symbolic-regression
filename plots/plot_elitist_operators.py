...
save_path = os.path.join(save_path, '{}_elitist_operators_train.pdf'.format(args.dataset))
plt.tight_layout()
...
# save_path, _ = os.path.split(args.scores[0])
# save_path = os.path.join(save_path, '{}_elitist_operators_best_test.pdf'.format(args.dataset))
# plt.tight_layout()
# plt.savefig(save_path, format='pdf')


save_path, _ = os.path.split(args.scores[0])
save_path = os.path.join(save_path, '{}_elitist_operators_best.pdf'.format(args.dataset))
plt.tight_layout()
plt.savefig(save_path, format='pdf')